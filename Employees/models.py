...
class PaymentDetail(models.Model):
    g_pay = models.CharField(max_length=100, blank=True, default = "")
    apple_pay = models.CharField(max_length=100, blank=True, default = "")
    paypal = models.CharField(max_length=100, blank=True, default = "")
    samsung_pay = models.CharField(max_length=100, blank=True, default = "")
    cash_app = models.CharField(max_length=100, blank=True, default = "")
...
class Employee(models.Model):
    ...
    whatsapp_number = models.CharField(max_length=12, blank=True, default = "")
    telephone_number = models.CharField(max_length=12, blank=True, default = "")
    fax_number = models.CharField(max_length=12, blank=True, default = "")
    website = models.URLField(max_length=1000, blank=True, default = "")
    skype_id = models.CharField(max_length=100, blank=True, default = "")
    ...
    another_address1 = models.CharField(max_length=100, blank=True, default = "")
    another_address2 = models.CharField(max_length=100, blank=True, default = "")
    another_city = models.CharField(max_length=100, blank=True, default = "")
    another_state = models.CharField(max_length=100, blank=True, default = "")
    another_zipcode = models.CharField(max_length=100, blank=True, default = "")
    another_country = models.CharField(max_length=100, blank=True, default = "")

    payment_details = models.OneToOneField(PaymentDetail, on_delete = models.CASCADE, blank = True, null = True)

    email_address1 = models.EmailField(max_length=12, blank=True, default = "")
    email_address2 = models.EmailField(max_length=12, blank=True, default = "")
    email_address3 = models.EmailField(max_length=12, blank=True, default = "")
    ...
    mobile1 = models.CharField(max_length=12, blank=True, default = "")
    mobile2 = models.CharField(max_length=12, blank=True, default = "")
    mobile3 =  models.CharField(max_length=12, blank=True, default = "")
