$(document).ready(function() {
    ...
    $("#phoneInput2").intlTelInput();
    $("#phoneInputadi1").intlTelInput();
    $("#phoneInputadi2").intlTelInput();
    $("#phoneInputadi3").intlTelInput();


    // start mobile menu toggle area
    $('.mobileHeadeToggle span').on('click',function(){
        $('#mobileHederContent').toggleClass('show');
    })
